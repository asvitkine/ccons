// This file contains code copied from clang-cc.cpp.
// This is a temporary measure until the clang libraries
// are cleaned up to export this functionality.
// See: http://llvm.org/bugs/show_bug.cgi?id=3979
