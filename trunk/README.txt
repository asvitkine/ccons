...
4. Install protobuf from:

   http://code.google.com/p/protobuf/

5. Install CMake if necessary.

6. Run "cmake CMakeLists.txt" from the ccons directory.

7. Build ccons using the build files generated by CMake (ie: 'make' on Unix).
